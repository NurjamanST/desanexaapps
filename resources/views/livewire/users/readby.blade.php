<section>
    ...
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Data Akses Penduduk') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Kelola data akses penduduk dari sini:') }}</flux:subheading>
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item :href="route('kades.kelola_users.read')">Akses Penduduk</flux:breadcrumbs.item>
        </flux:breadcrumbs>
        {{-- End breadcrumbs --}}
