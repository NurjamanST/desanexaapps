...
new #[Layout('components.layouts.auth')] class extends Component {
    ...
    public function login()
    {
        ...
        // Lakukan Pengecekan Role dan Redirect Berdasarkan Role yang Signin
        ...
        elseif (auth()->user()->role === UserRole::Penduduk) {
            return redirect()->route("penduduk.dashboard")->with("success", "successfully...");
        } else {
