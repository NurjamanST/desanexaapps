<section>
    ...
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Upload Berkas Persyaratan') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Kelola data berkas persyaratan dari sini:') }}</flux:subheading>
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item :href="route('penduduk.uploadpersyaratan')">Berkas Persyaratan</flux:breadcrumbs.item>
        </flux:breadcrumbs>
        {{-- End breadcrumbs --}}
        ...
        <div>
            ...
            <flux:modal.trigger name="add_submission-requirement">
            ...
            <livewire:submission-requirement.create />
            ...
            <div class="overflow-x-auto my-5">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Nama Persyaratan</th>
                        <th scope="col" class="px-6 py-3">File Persyaratan</th>
                        <th scope="col" class="px-6 py-3">Actions</th>
                    </tr>
                    </thead>
                    <tbody>
                        @forelse ($SubmissionRequirement as $subreq)
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                                ...
                                <td class="px-6 py-2 text-gray-600 dark:text-gray-300">
                                    @php
                                        $filePath = $subreq->file_persyaratan;
                                ...
                                <td class="px-6 py-2">
                                    ...
                                    <flux:button variant="danger" wire:click="confirmDelete({{ $subreq->id_subreq }})" size="sm" class="text-xs ml-1">
                        ...
                        @empty
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                                <td class="text-center py-5" colspan="4">Data Berkas Persyaratan Belum Tersedia, Silahkan tambahkan terlebih dahulu...</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                @if ($deleting && $deleteId)
                    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm transition-opacity">
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md shadow-lg">
                            ...
                            <h2 class="text-lg font-semibold mb-4">Hapus Berkas Persyaratan?</h2>

                            <p class="mb-4 text-gray-700 dark:text-gray-300">
                                Apakah Anda yakin ingin menghapus Berkas Persyaratan berikut?
